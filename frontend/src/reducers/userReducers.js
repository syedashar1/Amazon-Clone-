...
export const userDeleteReducer = (state = {}, action) => {
        switch (action.type) {
          ...
          case USER_DELETE_SUCCESS:
            return { loading: false, success: true , id : action.payload.userId  };
